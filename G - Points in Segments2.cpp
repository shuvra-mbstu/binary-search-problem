...
*/
long long int test,num,val,a,b,query,arr[100007],cas=0,x,y;
long long int binarylo()
{
    long long int lo=0,hi=num-1,mid,aa=-1;
//cout<<"DFD\n";
    while(lo<=hi)
    {
          // cout<<lo<<" "<< hi<<" "<<mid<<endl;
        ...
        if((arr[mid]>=a))
        {
            ...
            lo=mid+1;
                  //    cout<<lo<<" "<< hi<<" "<<mid<<" "<<arr[mid]<<" "<<a<<" "<<b<<endl;
